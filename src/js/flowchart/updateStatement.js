function UpdateStatement(wrapper, payload) {
    this.wrapper = wrapper;
    this.payload = payload;
}

UpdateStatement.prototype.createID = function (id) {
...
UpdateStatement.prototype.declareNode = function () {
    this.payload.flowchart.data = this.getID() + '=>operation: ' + '(' + this.getID() + ')\n' + this.getOperation();
};

UpdateStatement.prototype.getOperation = function () {
    return this.payload.name;
};

UpdateStatement.prototype.getID = function () {
    return this.payload.flowchart.id;
};

UpdateStatement.prototype.updateNextNode = function () {
...
UpdateStatement.prototype.createNodeDeclarationCode = function (nodeDeclarationCode) {
    nodeDeclarationCode.push(this.payload.flowchart.data);
};

UpdateStatement.prototype.createNodeNextCode = function (nodeDeclarationCode) {
...
UpdateStatement.prototype.markNodeAsVisited = function (isFunctionDone) {
